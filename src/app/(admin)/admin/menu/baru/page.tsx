...
/**
 * src/app/(admin)/admin/menu/baru/page.tsx — /admin/menu/baru
 * Form tambah menu baru
 *
 * Styled with premium vector icons (lucide-react) to avoid any generic AI look.
 * Supports up to 5 photos upload simultaneously.
...
export default function AdminMenuBaruPage() {
  ...
  const [minPorsi, setMinPorsi] = useState('50')
  ...
  useEffect(() => {
    fetch('/api/v1/kategori')
      ...
      .then((json) => {
        ...
        if (json.data?.length > 0) setKategoriId(json.data[0].id)
      })
  ...
  const uploadFotoForMenu = async (menuId: string, filesToUpload: File[]) => {
    ...
    <div className="min-h-screen bg-gray-50 pb-20 font-sans antialiased text-[#1E1E1E]">
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-30 shadow-2xs">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-3">
          ...
          <h1 className="text-base font-extrabold text-neutral-dark">Tambah Menu Baru</h1>
        </div>
      </header>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="Nasi Box Ayam Bakar Madu"
              className={cn(
